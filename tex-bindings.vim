...
autocmd Filetype tex,latex,plaintex nnoremap <buffer> k gk
autocmd Filetype tex,latex,plaintex nnoremap <buffer> j gj

autocmd Filetype tex,latex,plaintex inoremap <buffer> <C-b> \textbf{}i
autocmd Filetype tex,latex,plaintex vnoremap <buffer> <C-b> `>a}`<i\textbf{lviB
...
autocmd Filetype tex,latex,plaintex vnoremap <buffer> <C-i> `>a}`<i\emph{lviB
...
autocmd Filetype tex,latex,plaintex inoremap <buffer> <C-f> \dfrac{}{}F}i
